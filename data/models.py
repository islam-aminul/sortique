...
class FileRecord:
    ...
    def from_dict(cls, data: dict) -> FileRecord:
        ...
        return cls(
            ...
            file_type=FileType(data["file_type"].lower()),
            ...
            status=FileStatus(data["status"].lower()),
            skip_reason=data.get("skip_reason"),
            error_message=data.get("error_message"),
            date_value=date_val,
            date_source=DateSource(data.get("date_source", "none").lower()),
            timezone_offset=data.get("timezone_offset"),
            exif_status=ExifStatus(data.get("exif_status", "none").lower()),
            exif_data=exif,
...
class DuplicateGroup:
    ...
    def from_dict(cls, data: dict) -> DuplicateGroup:
        return cls(
            ...
            match_type=DupMatchType(data["match_type"].lower()),
